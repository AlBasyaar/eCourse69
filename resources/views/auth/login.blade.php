...
@section('content')
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white rounded-3xl shadow-2xl flex max-w-4xl w-full overflow-hidden">
            ...
            <div class="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center relative">
                ...
                <div class="space-y-6">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('login') }}">
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                            class="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-xl transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Masuk
                        </button>
            ...
            <div
                class="hidden lg:flex lg:w-1/2 from-blue-50 to-purple-50 dark:from-gray-900 dark:to-purple-900/40 items-center justify-center p-4 relative">
                <!-- Logo positioned at top right of illustration -->
                <div class="absolute top-6 right-6 z-10">
                    <img src="https://res.cloudinary.com/dr5pehdsw/image/upload/v1752056700/69_uq1r75.png" alt="School Logo"
                ...
                <div class="w-full h-full flex flex-col items-center justify-center text-center space-y-4">
                    ...
                    <div class="flex-1 flex items-center justify-center">
                        <img src="https://res.cloudinary.com/dr5pehdsw/image/upload/v1756307010/rafiki_gmpthz.png"
                            alt="Login Illustration" class="w-full h-full max-w-none object-contain">
                    </div>
