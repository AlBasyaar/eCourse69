    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.mentors.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
            ...
            <div class="p-6">
                <form action="{{ route('admin.mentors.update', $mentor) }}" method="POST">
                    ...
                    <div class="mt-8 flex justify-end space-x-4">
                        <a href="{{ route('admin.mentors.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                            Cancel
                        </a>
