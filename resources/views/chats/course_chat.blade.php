...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        ...
        <div class="p-6">
            ...
            <!-- Send Message Form -->
            <form method="POST" action="{{ route('chats.course.send', $course) }}" class="flex space-x-4">
                @csrf
                <div class="flex-1">
                ...
                <div class="flex items-end">
                    <button type="submit" 
                            class="bg-primary text-white px-6 py-2 rounded-md hover:bg-secondary transition duration-300 h-fit">
