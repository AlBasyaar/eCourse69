    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('chats.mentor_chats.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
                ...
                <form action="{{ route('chats.mentor_chats.send', $otherUser) }}" method="POST">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-shrink-0">
                            <button type="submit" class="h-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
